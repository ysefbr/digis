...
export const CheckoutModal: React.FC<CheckoutModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/85 backdrop-blur-md overflow-y-auto">
      <div className="relative w-full max-w-lg max-h-[92vh] overflow-y-auto bg-[#0a0f26] border border-blue-500/30 rounded-3xl p-5 sm:p-8 shadow-2xl shadow-purple-500/20 text-white my-auto">
